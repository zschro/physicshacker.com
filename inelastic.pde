...
*/    
  ...
  void collideWith(Ball b2) {
    float C = 0.7; //Coefficient of restitution

    float origvX = vX;
    float orig2vX = b2.vX;

    vX = (C*b2.mass*(orig2vX-origvX)+mass*origvX+b2.mass*orig2vX)/(mass+b2.mass);
    b2.vX = (C*mass*(origvX-orig2vX)+mass*origvX+b2.mass*orig2vX)/(mass+b2.mass);
    /*
    float origvY = vY;
    float orig2vY = b2.vY;
    
    vY = (origvY*(mass-b2.mass)+2*b2.mass*orig2vY)/(mass+b2.mass);
    b2.vY = (orig2vY*(b2.mass-mass)+2*mass*origvY)/(mass+b2.mass); 
    */
  }
